...
const Login = () => {
  ...
  const handleLogin = data => {
    ...
    return (
<div>
<div className='h-[800px] flex justify-center items-center whiteColor'>
            <div className='w-96 p-7'>
                ...
                <p className='text-black'>You are new here? <Link className='text-secondary' to="/">Create new Account</Link></p>
